...
> _Chrome, Edge, Safari_ 등이 대표적인 웹 브라우저다.
...
웹 브라우저의 주소창에 http://day0522.github.io/index.html 를 입력하면 *day0522.github.io*에 존재하는 _/index.html_ 리소스에 대해 요청을 수행하는 것이다.
...
- **Header**
  ...
  - 사용자와 서버가 상호작용하기 위한 정보를 담는 부분
    _ex) 사용자 데이터의 처리 방식 및 형식에 대한 정보, 서버에서 사용자를 식별하기 위한 쿠기 정보 등_
